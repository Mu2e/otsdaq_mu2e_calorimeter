...
#define __MF_SUBJECT__ "FE-ROCCalorimeterEmulator"


//=========================================================================================
ROCCalorimeterEmulator::ROCCalorimeterEmulator(
...
bool ROCCalorimeterEmulator::emulatorWorkLoop(void)
{	
...
DEFINE_OTS_INTERFACE(ROCCalorimeterEmulator)
